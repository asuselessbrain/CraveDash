...
export default function CategoryCarousel() {
  return (
    <section className="mx-auto mt-12 max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div className="group relative overflow-hidden px-3 py-4">
        ...
        <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-16 bg-linear-to-l from-orange-100 to-transparent dark:from-slate-800" />
