...
router6.post("/", auth_default(Role.CUSTOMER), OrderController.createOrder);
router6.get("/my", auth_default(Role.CUSTOMER), OrderController.getMyOrders);
router6.get("/provider", auth_default(Role.PROVIDER), OrderController.getProvidersOrders);
router6.get("/admin", auth_default(Role.ADMIN), OrderController.getAdminOrders);
router6.get("/admin/:id", auth_default(Role.ADMIN), OrderController.getAdminOrderById);
